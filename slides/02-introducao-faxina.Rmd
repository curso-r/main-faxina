...
Essas definições são um interdependentes, a depender do que entendermos por **visão principal** e **observação**. O que realmente é a filosogia por trás das sugestões.
